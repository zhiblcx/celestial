---
title: 'React系列 —— 服务端渲染'
description: '面试官：说说React服务端渲染怎么做？原理是什么？'
pubDate: '2024-09-27 20:10:00'
category: 'interview'
cardImage: '@images/interview/react/main/react-service-rendering.png'
...
![''](@images/interview/react/react-service-rendering/image.png)
...
然后在服务器中编写 react 代码，在 app.js 中进行应引用
...
是像一些事件处理的方法，是无法在服务端完成，因此需要将组件代码在浏览器中再执行一遍，这种服务器端和客户端共用一套代码的方式就称之为**同构**
...
然后在客户端执行以下 **react** 代码，新建 **webpack.client.js** 作为客户端 **React** 代码的 **webpack** 配置文件如下：
...
![''](@images/interview/react/react-service-rendering/image2.png)
...
[文章来源](https://vue3js.cn/interview/React/server%20side%20rendering.html)
