---
title: 'git系列 —— git 常见的命令'
description: '面试官：说说Git常用的命令有哪些？'
pubDate: '2024-10-13 20:07:00'
category: 'interview'
cardImage: '@images/interview/git/main/git-common-order.png'
tags: ['interview', 'git']
selected: true
show: false
---
...
![''](@images/interview/git/git-common-order/image.png)
...
![''](@images/interview/git/git-common-order/image2.png)

[文章来源](https://vue3js.cn/interview/git/command.html)
