---
title: 'javascript系列 —— 浮点数精度丢失问题'
description: '面试官：说说 Javascript 数字精度丢失的问题，如何解决？'
pubDate: '2024-09-30 19:42:00'
category: 'interview'
cardImage: '@images/interview/javascript/main/js-precision-lost.png'
tags: ['interview']
selected: true
show: false
---
...
![''](@images/interview/javascript/js-precision-lost/image.png)
...
![''](@images/interview/javascript/js-precision-lost/image2.png)

前面讲到，**javaScrip** t存储方式是双精度浮点数，其长度为8个字节，即64位比特
...
![''](@images/interview/javascript/js-precision-lost/image3.png)

举个例子：

27.5 转换为二进制11011.1

11011.1转换为科学记数法 ![''](@images/interview/javascript/js-precision-lost/image4.png)
...
[文章来源](https://vue3js.cn/interview/JavaScript/loss_accuracy.html)
