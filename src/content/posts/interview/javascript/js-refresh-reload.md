---
title: 'javascript系列 —— 上拉加载，下拉刷新'
description: '面试官：如何实现上拉加载，下拉刷新？'
pubDate: '2024-10-01 13:19:00'
category: 'interview'
cardImage: '@images/interview/javascript/main/js-refresh-reload.png'
tags: ['interview']
selected: true
show: false
---
...
![''](@images/interview/javascript/js-refresh-reload/image.png)
...
- scrollHeight：页面不能滚动时也是存在的,此时 scrollHeight 等于clientHeight。scrollHeight 表示 body 所有元素的总长度(包括body元素自身的padding)
...
[文章来源](https://vue3js.cn/interview/JavaScript/pull_up_loading_pull_down_refresh.html)
