...
category: 'interview'
cardImage: '@images/interview/javascript/main/js-regexp.png'
tags: ['interview']
selected: true
show: false
---
...
**regexp.lastIndex** 中。 下一次同样的调用会从位置 **regexp.lastIndex** 开始搜索，返回下一个匹配项，并将其后的位置保存在 **regexp.lastIndex** 中
...
[文章来源](https://vue3js.cn/interview/JavaScript/regexp.html)
