---
title: 'javascript系列 —— 内存泄漏'
description: '面试官：说说 JavaScript 中内存泄漏的几种情况？'
pubDate: '2024-09-08 18:28:00'
category: 'interview'
cardImage: '@images/interview/javascript/main/js-memory-leak.png'
tags: ['interview']
selected: true
show: false
---
...
![''](@images/interview/javascript/js-memory-leak/image.png)
...
上面代码中，数组 [1, 2, 3, 4] 是一个值，会占用内存。变量 arr 是仅有的对这个值的引用，因此引用次数为1。尽管后面的代码没有用到 arr，它还是会持续占用内存
...
[文章来源](https://vue3js.cn/interview/JavaScript/memory_leak.html)
