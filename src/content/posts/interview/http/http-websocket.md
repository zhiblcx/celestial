---
title: 'http系列 —— websocket'
description: '面试官：说说对WebSocket的理解？应用场景？'
pubDate: '2024-10-12 21:33:00'
category: 'interview'
cardImage: '@images/interview/http/main/http-websocket.png'
tags: ['interview']
selected: true
show: false
---
...
![''](@images/interview/http/http-websocket/image.png)
...
[文章来源](https://vue3js.cn/interview/http/WebSocket.html)
