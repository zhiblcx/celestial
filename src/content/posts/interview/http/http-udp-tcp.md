...
category: 'interview'
cardImage: '@images/interview/http/main/http-udp-tcp.png'
tags: ['interview']
selected: true
show: false
---
...
**UDP** 报头包括 4 个字段，每个字段占用 2 个字节（即16个二进制位），标题短，开销小

![''](@images/interview/http/http-udp-tcp/image.png)
...
![''](@images/interview/http/http-udp-tcp/image2.png)
...
![''](@images/interview/http/http-udp-tcp/image3.png)
...
![''](@images/interview/http/http-udp-tcp/image4.png)

可以看到，TCP 应用场景适用于对效率要求低，对准确性要求高或者要求有链接的场景，而UDP 适用场景为对效率要求高，对准确性要求低的场景

[本章来源](https://vue3js.cn/interview/http/UDP_TCP.html)
