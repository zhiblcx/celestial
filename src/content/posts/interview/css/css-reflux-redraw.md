...
具体的浏览器解析渲染机制如下所示：
![''](@images/interview/css/css-reflux-redraw/image.png)
...
回流这一阶段主要是**计算节点的位置**和**几何信息**，那么当**页面布局**和**几何信息**发生变化的时候，就需要回流，如下面情况：
...
[本章来源](https://vue3js.cn/interview/css/layout_painting.html)
