...
![''](@images/interview/css/css-parallax-scroll/image.png)
当滚动鼠标滑轮的时候，各个图层以不同的速度移动，形成视觉差的效果

![''](@images/interview/css/css-parallax-scroll/image2.png)
...
完成滚动视觉差就需要将 **background-attachment** 属性设置为 **fixed**，让背景相对于视口固定。即使一个元素有滚动机制，背景也不会随着元素的内容而滚动
...
![''](@images/interview/css/css-parallax-scroll/image3.png)
...
[本章来源](https://vue3js.cn/interview/css/visual_scrolling.html)
